...
if __name__ == "__main__":
    ...
    data_path ="/home/ubuntu/try_HMB/data_all/all/"

    print( "Pre-processing phase 2 data...")
    X_train, y_train = make_hsv_grayscale_diff_data("{}/interpolated_center_all_train.csv".format(data_path), 4)
    np.save("{}/X_train_round2_hsv_gray_diff_ch4_all_train".format(data_path), X_train)
    np.save("{}/y_train_round2_hsv_gray_diff_ch4_all_train".format(data_path), y_train)
