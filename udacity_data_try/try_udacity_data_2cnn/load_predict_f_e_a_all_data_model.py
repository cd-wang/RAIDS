...
test_dataset=intrusion_data(csv_file='interpolated_attack_a_directive_0p25_1_all_test.csv',root_dir='/home/pi/new_try_raspberry_pi/udacity_data_try_pi/all',cs=1,transform=transforms.Compose([transforms.Resize(256),transforms.RandomResizedCrop(224),transforms.ToTensor()]))
...
net.eval()
net = torch.load('saved_consecutive_models/epoch_4.pt')
loss1 = 0
finale = 0
train_loss = 0
finale_1 = 0
