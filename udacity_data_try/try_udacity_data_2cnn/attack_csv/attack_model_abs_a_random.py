...
root_dir = "./csv_file/all"

csv_file = "interpolated_center_all_test.csv"
...
for folder in all_folders:
    ...
    csv_input.to_csv(os.path.join(folder, 'interpolated_center_attack_a_0p15to0p8_all_test_10147.csv'), index = False)
