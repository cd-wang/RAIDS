...
test_dataset = intrusion_data(csv_file='consecutive_0p1to0p9_all_test_10147_batch_same.csv', root_dir='./csv_data', cs=1,
...
net.eval()
net = torch.load('saved_models_consecutive_0p25-1/epoch_1.pt')
