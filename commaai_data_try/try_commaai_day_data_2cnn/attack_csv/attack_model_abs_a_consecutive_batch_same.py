...
def launch_attack(csv_input):
    ...
    b_choose = random.sample(b, 170)
    b_choose.sort()
    print("b_choose: ",b_choose)
    for row1 in b_choose:

        rnd = random.uniform(0.25, 1)
        temp = randint(1, 2)
        if temp == 2:
            operation = 1
        else:
...
root_dir = "./day_data"
csv_file = "01-03--13-46-00_72710to262220_f10_5687.csv"
...
for folder in all_folders:
    ...
    csv_input.to_csv(os.path.join(folder, '01-03-attack_f10_consecu_attack_0p2_0p9_test_5687.csv'), index = False)
