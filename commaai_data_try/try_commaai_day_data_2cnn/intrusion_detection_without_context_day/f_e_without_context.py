...
face_dataset = intrusion_data(csv_file='01-03--13-46-00_72710to262220_f10_random_attack_0p2_0p9_13267.csv', root_dir='./data', cs=1,
                              transform=transforms.Compose(
                                  [transforms.Resize(256),
                                   transforms.RandomResizedCrop(224),
                                   transforms.ToTensor()]))

test_dataset = intrusion_data(csv_file='01-03--13-46-00_72710to262220_f10_random_attack_0p2_0p9_5687.csv', root_dir='./data', cs=1,
                              transform=transforms.Compose(
                                  [transforms.Resize(256),
                                   transforms.RandomResizedCrop(224),
                                   transforms.ToTensor()]))
...
# &&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&TESTING &&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&
    ...
    # print(filenm)
    torch.save(net, os.path.join(('saved_models_random-0p2-0p9'), filenm))
