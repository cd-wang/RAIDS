...
face_dataset = intrusion_data(csv_file='05-12--22-20-00_40140to203010_f10_random_attack_0p2_0p9_11402.csv',
...
test_dataset=intrusion_data(csv_file='05-12--22-20-00_40140to203010_f10_random_attack_0p2_0p9_4888.csv',
                            root_dir='/home/pi/new_try_raspberry_pi--/commaai_data_try--/commaai_night_try/commaai_dark_data',
                            cs=1,transform=transforms.Compose([transforms.Resize(256),transforms.RandomResizedCrop(224),transforms.ToTensor()]))
# out=[]
