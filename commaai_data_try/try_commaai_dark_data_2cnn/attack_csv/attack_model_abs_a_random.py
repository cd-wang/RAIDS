...
csv_file = "05-12--22-20-00_40140to203010_f10.csv"
...
for folder in all_folders:
    ...
    csv_input.to_csv(os.path.join(folder, '05-12--22-20-00_40140to203010_f10_random_attack_0p25_1.csv'), index = False)
