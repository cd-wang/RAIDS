...
csv_file = "05-12--22-20-00_40140to203010_f10_11402.csv"
...
for folder in all_folders:
    ...
    csv_input.to_csv(os.path.join(folder, '05-12_f10_a_consecutive_0p25_1_batch_11402.csv'), index = False)
