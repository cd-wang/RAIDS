...
class Model(object):
    ...
    def predict(self, img_path):
        img1 = load_img(img_path, grayscale=True, target_size=(80, 160))
...
test_dataset=intrusion_data(csv_file='05-12--22-20-00_40140to203010_f10_4888_directive_turn.csv',
                            root_dir='/home/pi/new_try_raspberry_pi--/commaai_data_try--/commaai_night_try/commaai_dark_data',
...
net.eval()
net = torch.load('saved_consecutive_models/epoch_12.pt')
loss1 = 0
finale = 0
train_loss = 0
finale_1 = 0
