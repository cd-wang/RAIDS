...
test_dataset=intrusion_data(csv_file='interpolated_attack_test_directive_0p25_1_2413.csv',root_dir='/home/pi/new_try_raspberry_pi--/simulate_data',cs=1,transform=transforms.Compose([transforms.Resize(256),transforms.RandomResizedCrop(224),transforms.ToTensor()]))
