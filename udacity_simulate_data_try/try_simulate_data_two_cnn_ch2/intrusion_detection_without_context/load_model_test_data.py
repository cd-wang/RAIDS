...
test_dataset = intrusion_data(csv_file='interpolated_attack_a_directive_0p25_1_len1501.csv', root_dir='./data', cs=1,
...
net.eval()
net = torch.load('saved_models_consecutive/epoch_0.pt')
