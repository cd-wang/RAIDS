...
if __name__ == "__main__":
    ...
    X_train1 = np.load(data_path + "/X_train_round2_" + config.data_name + "_all_sim.npy")
    y_train1 = np.load(data_path + "/y_train_round2_" + config.data_name + "_all_sim.npy")
    ...
    if config.val_part == 6:
        X_train = X_train1[:5626]
        y_train = y_train1[:5626]
        X_test = X_train1[5626:]
        y_test = y_train1[5626:]
