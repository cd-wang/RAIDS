...
if __name__ == "__main__":
    ...
    X_train1 = np.load(data_path + "/X_train_round2_" + config.data_name + "_0to24561.npy")
    y_train1 = np.load(data_path + "/y_train_round2_" + config.data_name + "_0to24561.npy")
    # X_train2 = np.load(data_path + "/X_train_round2_" + config.data_name + "_part2_100.npy")
    # y_train2 = np.load(data_path + "/y_train_round2_" + config.data_name + "_part2_100.npy")
    # X_train3 = np.load(data_path + "/X_train_round2_" + config.data_name + "_part3_100.npy")
    # y_train3 = np.load(data_path + "/y_train_round2_" + config.data_name + "_part3_100.npy")
    # X_train4 = np.load(data_path + "/X_train_round2_" + config.data_name + "_part4_100.npy")
    # y_train4 = np.load(data_path + "/y_train_round2_" + config.data_name + "_part4_100.npy")
    # X_train5 = np.load(data_path + "/X_train_round2_" + config.data_name + "_part5_100.npy")
    # y_train5 = np.load(data_path + "/y_train_round2_" + config.data_name + "_part5_100.npy")
    ...
    # use last frames from all parts as validation set
        ...
        X_train = X_train1[:17192]
        y_train = y_train1[:17192]
        X_test = X_train1[17192:]
        y_test = y_train1[17192:]
