...
if __name__ == "__main__":
    ...
    X_train, y_train = make_hsv_grayscale_diff_data("{}/interpolated_0to24561.csv".format(data_path), 2)
    np.save("{}/X_train_round2_hsv_gray_diff_ch2_0to24561".format(data_path), X_train)
    np.save("{}/y_train_round2_hsv_gray_diff_ch2_0to24561".format(data_path), y_train)
