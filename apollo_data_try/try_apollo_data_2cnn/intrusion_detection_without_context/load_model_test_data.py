...
test_dataset = intrusion_data(csv_file='interpolated_test_7370_consecutive_0p08_0p5_batch_same.csv', root_dir='./data', cs=1,
...
net.eval()
net = torch.load('saved_models_consecutive_0p25-1/epoch_0.pt')
