...
# face_dataset = intrusion_data(csv_file='interpolated_attack_a_consecutive_0p25_1_1382.csv',root_dir='./HMB_4',cs=1,transform=transforms.Compose([transforms.Resize(256),transforms.RandomResizedCrop(224),transforms.ToTensor()]))
test_dataset=intrusion_data(csv_file='interpolated_0to24561_a_directive_0p25_1_7370.csv',root_dir='/home/pi/new_try_raspberry_pi/apollo_data_try/apollo_date',cs=1,transform=transforms.Compose([transforms.Resize(256),transforms.RandomResizedCrop(224),transforms.ToTensor()]))
...
net.eval()
net = torch.load('saved_consecutive_models/epoch_0.pt')
loss1 = 0
finale = 0
train_loss = 0
finale_1 = 0
