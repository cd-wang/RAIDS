...
X_train1 = np.load(data_path + "/X_train_round2_" + config.data_name + "_100m100_0to24561.npy")
# X_train2 = np.load(data_path + "/X_train_round2_" + config.data_name + "_part2_100.npy")
# X_train3 = np.load(data_path + "/X_train_round2_" + config.data_name + "_part3_100.npy")
# X_train4 = np.load(data_path + "/X_train_round2_" + config.data_name + "_part4_100.npy")
# X_train5 = np.load(data_path + "/X_train_round2_" + config.data_name + "_part5_100.npy")

X_train = X_train1[:17191]
...
face_dataset = intrusion_data(csv_file='interpolated_0to24561_random_attack_a_0p08_0p5_17192.csv',root_dir='./data',cs=1,transform=transforms.Compose([transforms.Resize(256),transforms.RandomResizedCrop(224),transforms.ToTensor()]))
test_dataset=intrusion_data(csv_file='interpolated_0to24561_random_attack_a_0p08_0p5_7370.csv',root_dir='./data',cs=1,transform=transforms.Compose([transforms.Resize(256),transforms.RandomResizedCrop(224),transforms.ToTensor()]))
# out=[]
...
for iter_x in range(epochs):
    ...
    # print(filenm)
    torch.save(net, os.path.join(('saved_random_models'), filenm))
