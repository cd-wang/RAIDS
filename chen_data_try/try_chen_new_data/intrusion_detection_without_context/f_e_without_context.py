...
face_dataset = intrusion_data(csv_file='interpolated_2188to16447_attack_a_0p2_0p9_9982.csv', root_dir='./data', cs=1,
                              transform=transforms.Compose(
                                  [transforms.Resize(256),
                                   transforms.RandomResizedCrop(224),
                                   transforms.ToTensor()]))

test_dataset = intrusion_data(csv_file='interpolated_2188to16447_attack_a_0p2_0p9_4280.csv', root_dir='./data', cs=1,
                              transform=transforms.Compose(
                                  [transforms.Resize(256),
                                   transforms.RandomResizedCrop(224),
                                   transforms.ToTensor()]))
